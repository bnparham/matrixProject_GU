...
while(menu):    
    ...
    if vorodi == 1:
        ...
        print_graphic_matrix(mat_total)
        print("----------------------------")
        print("Ax = b")
        print(f"A : {mat_A_copy}")
        print_graphic_matrix(mat_A_copy)
        print(f"b : {mat_b}")
        print("--------------------------")
        print(f"{mat_A_copy}x = {mat_b} ")
        li_total__2 = []
        li_total__2.append(mat_b)
        for i in range(len(mat_A_copy)-1):
            li_total__2.append(["" for i in mat_b])
        matrix_reformat(mat_A_copy,transpose(li_total__2))
    ...
    if vorodi == 3:
        if det_answ != 0 :
            ...
            print("determiant is 0 and can not calculate eqation.")
    if vorodi == 4:
    ...
    if vorodi == 5:
        if(det_answ != 0):
            ...
            print("determinant is 0 and can not calculate the inverse of matrix")   
    if vorodi == 6:
        error = True
        while(error):   
            try:
    ...
    if vorodi == 8 :
        if(det_answ != 0):
            ...
            print("determiant is 0 and can not calculate the inverse of matrix")
    ...
    if vorodi == 9:
        if (det_answ != 0):
            ...
            print("determiant is 0 and can not calculate the equation")